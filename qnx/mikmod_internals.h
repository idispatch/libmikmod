...
#ifndef MIKMOD_BUILD_H_INCLUDED
...
extern void Voice_SetVolume_internal(SBYTE voice,UWORD vol);
extern void Voice_SetPanning_internal(SBYTE voice,ULONG pan);
extern void Voice_SetPanning_internal(SBYTE,ULONG);
extern void Voice_SetFrequency_internal(SBYTE voice,ULONG frq);
